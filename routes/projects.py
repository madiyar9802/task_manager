...
@requires_auth
def get_projects():
    current_app.logger.info("All projects requested")
...
def get_project_id(project_id):
    current_app.logger.info(f"Project {project_id} was requested")
...
@requires_auth
def create_project():
    current_app.logger.info("New project was created")
...
def update_project(project_id):
    current_app.logger.info(f"Project {project_id} was updated")
