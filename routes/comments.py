...
def create_comment(task_id):
    current_app.logger.info(f"A new comment has been created for task {task_id} by user: {g.username}")
...
def update_comment(task_id, comment_id):
    current_app.logger.info(f"Comment {comment_id} for task {task_id} was updated by user: {g.username}")
...
def delete_comment(task_id, comment_id):
    current_app.logger.info(f"Comment {comment_id} for task {task_id} was deleted by user: {g.username}")
