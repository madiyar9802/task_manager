...
@comment_bp.route('/<int:task_id>/create_comment', methods=['POST'])
@requires_auth
def create_comment(task_id):
    return comments_logic.create_comment(task_id)


@comment_bp.route('/<int:task_id>/update_comment/<int:comment_id>', methods=['PUT'])
@requires_auth
def update_comment(task_id, comment_id):
    return comments_logic.update_comment(task_id, comment_id)


@comment_bp.route('/<int:task_id>/delete_comment/<int:comment_id>', methods=['DELETE'])
@requires_auth
