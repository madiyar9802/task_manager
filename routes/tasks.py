...
@requires_auth
def get_tasks():
    current_app.logger.info(f"All tasks requested")
...
def get_task_id(task_id):
    current_app.logger.info(f"Task {task_id} was requested")
...
@requires_auth
def create_task():
    current_app.logger.info("New task was created")
...
def update_task(task_id):
    current_app.logger.info(f"Task {task_id} was updated")
